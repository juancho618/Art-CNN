    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            for i in range(len(images)):
                ...
                # io.show()
            np.save('./1up/results/file.npy', np.array(result_images))
...
if __name__ == '__main__':
    tf.app.flags.DEFINE_string('checkpoint_file_path', '1up/checkpoints/model.ckpt-75-75', 'path to checkpoint file')
